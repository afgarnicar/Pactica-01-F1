public class RearJack  extends PitCrewTeam implements PitCrewTask {
    ...
    public RearJack( String trabajo, String nombre1, String nombre2) {
        super(2);
